...
<section class="updates-details hero-banner">
    <div class="container-fluid">
     <div class="updates-banner">
         <img src="images/updates/updates-details.jpg" alt="">
         <div class="overlay">
             <h3 class="updates-details-heading">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Hic asperiores explicabo architecto dolore nulla esse.</h3>   
         </div>
...
<section class="details-description scroll-to pt pb">
    <div class="continer">

        <svg viewBox="0 0 512 680" fill="none" xmlns="http://www.w3.org/2000/svg">
            <rect width="512" height="680" fill="#FDF9F4"/>
            </svg>
            
        <div class="row">
            <div class="col-sm-6 updates-des-mobile">
            ...
            <div class="col-sm-6 pad-left">
                <div class="recent-news">
                    <img src="images/updates/recent-news01.jpg" alt="">
